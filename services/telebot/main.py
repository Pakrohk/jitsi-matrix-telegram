...
from evoid.adapters.telegram import create_bot, on, run_bot, set_proxy
...
_proxy_username = _proxy_cfg.get("username", "")
_proxy_password = _proxy_cfg.get("password", "")
...
def create_telegram_bot():
    ...
    if _proxy_enabled:
        ...
        if _proxy_username and _proxy_password:
            proxy_url = f"{_proxy_type}://{_proxy_username}:{_proxy_password}@{_proxy_host}:{_proxy_port}"
        elif _proxy_username:
            proxy_url = f"{_proxy_type}://{_proxy_username}@{_proxy_host}:{_proxy_port}"
        set_proxy(bot, proxy_url)
        log.info(f"Telegram bot using proxy: {_proxy_type}://{_proxy_host}:{_proxy_port}")
